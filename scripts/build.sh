...
mkdir -p "$TASK_APP/Contents/Helpers"
cp ".build/$BUILD_MODE/SproutHook" "$TASK_APP/Contents/Helpers/SproutHook.next"
mv -f "$TASK_APP/Contents/Helpers/SproutHook.next" "$TASK_APP/Contents/Helpers/SproutHook"
codesign --force --sign - "$TASK_APP/Contents/Helpers/SproutHook"
